...
type Props = {
  ...
  slug: string;
  /** Optional section label (shown in cyan caps above the title). */
 ...
 */
export default function ProductWorkspacePlaceholder({ title, slug, categoryLabel }: Props) {
  return (
    <main className="min-h-screen scroll-smooth bg-[#030712] text-slate-100">
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-10 sm:py-14 md:px-8 md:py-16">
          <p
            className={
              "text-[11px] font-bold tracking-[0.28em] text-cyan-400/90 sm:text-xs " +
              (categoryLabel ? "uppercase" : "")
            }
          >
            {categoryLabel ?? "PARABLE · workspace"}
          </p>
