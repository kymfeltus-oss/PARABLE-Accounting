-- =============================================================================
-- PARABLE: Document Vault — integrity hash + UI verification view
-- Run in Supabase SQL Editor (schema: parable_ledger).
-- document_url already exists on fresh installs (20250423210000); adds are idempotent.
-- =============================================================================
